...
(function (root) {
  root.DemoPresets = {
    ...
    "VU Dial":    { driver: { x: { src: "sine", rate: 1 }, y: { src: "noise", rate: 2 }, drive: "max" }, S: { variant: "dial", gamma: 1, redline: 0.85, _src: "sine", _rate: 1, _drive: "max" } },
    "Goniometer": { driver: { x: { src: "sine", rate: 2 }, y: { src: "sine", rate: 2, phase: 0.25 }, drive: "x" }, S: { variant: "gonio", gamma: 1, redline: 0.85, _src: "sine", _rate: 2, _drive: "x" } }
  };

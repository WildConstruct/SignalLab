...
(function (root) {
  root.DemoPresets = {
    ...
    "Lissajous":   { driver: { x: { src: "sine", rate: 0.5 }, drive: "x" },                                           S: { variant: "lissajous", lra: 3, lrb: 2, l3d: false, radius: 1, lmorph: 0.5, _src: "sine", _rate: 0.5, _drive: "x" } },
    "Lissajous 3D":{ driver: { x: { src: "sine", rate: 0.4 }, drive: "x" },                                           S: { variant: "lissajous", lra: 3, lrb: 2, lrc: 4, l3d: true, spin: 0.3, radius: 1, lmorph: 0.5, _src: "sine", _rate: 0.4, _drive: "x" } }
  };
